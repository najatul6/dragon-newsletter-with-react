    ...
    return (
        <div className="bg-[#F3F3F3]">
            <div className="max-w-[1440px] mx-auto min-h-screen">
                <Navbar></Navbar>
                <form onSubmit={handleRegister} className="w-full md:w-3/4 lg:w-1/2 shadow-xl bg-[#FFF] py-8 px-3 md:py-16 md:px-24 mt-10 md:mt-24 mx-auto rounded-lg">
                    <h2 className="text-2xl md:text-4xl font-semibold text-center">Register your account</h2>
                    <hr className="my-12" />
                    ...
                    <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                        ...
                        <Link
                            className="font-medium text-[#F75B5F] transition-colors pl-1"
                            to='/login'
                        >
                            Log In
                        </Link>
